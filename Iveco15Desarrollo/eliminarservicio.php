...
if(!isset ($_REQUEST['ip'])&&!isset($_REQUEST['puerto'])){
							}else{
								$ip=$_REQUEST['ip'];
...
<form action="eliminarservicio1.php?ip=<?php echo $ip; ?>&puerto=<?php echo $puerto; ?>" method="post" id="form_puerto">

<table align="center" cellpadding="7" bgcolor="#C1E0FF" border="1" bordercolor="#FFFFFF" frame="box" style="text-align:left;">  

<tr bgcolor="#000066">
<td colspan="2" align="center"><b><font color="#FFFFFF" size="+1"> Eliminar Puerto  </font></b></td>
</tr>
...
<td>  <font><?php echo $fila['puerto']; ?></font></td>
</tr>
