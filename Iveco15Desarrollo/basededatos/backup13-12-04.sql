...
INSERT INTO `controldeerrores` VALUES (160,'192.168.0.13','','Existe un error en el Dispositivo: Joselin Pc de ip: 192.168.0.13 el dia lunes 25 de noviembre del 2013 a las 12:48:33 pm',4,'2013-11-25','12:48:33','12:49:24','no'),(161,'192.168.0.13','','Existe un error en el Dispositivo: Joselin Pc de ip: 192.168.0.13 el dia lunes 25 de noviembre del 2013 a las 12:49:37 pm',4,'2013-11-25','12:49:37','12:49:55','no'),(162,'192.168.0.13','','Existe un error en el Dispositivo: Joselin Pc de ip: 192.168.0.13 el dia lunes 25 de noviembre del 2013 a las 5:00:43 pm',4,'2013-11-25','05:00:43','05:01:02','no'),(163,'192.168.0.13','','Existe un error en el Dispositivo: Joselin Pc de ip: 192.168.0.13 el dia lunes 02 de diciembre del 2013 a las 9:34:30 am',4,'2013-12-02','09:34:30','00:00:00','si'),(164,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 10:35:02 am',4,'2013-12-02','10:35:02','10:37:53','no'),(165,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 10:38:33 am',4,'2013-12-02','10:38:33','10:38:46','no'),(166,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 10:40:18 am',4,'2013-12-02','10:40:18','10:40:30','no'),(167,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 10:40:39 am',4,'2013-12-02','10:40:39','10:40:55','no'),(168,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 10:41:01 am',4,'2013-12-02','10:41:01','11:27:05','no'),(169,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 11:27:13 am',3,'2013-12-02','11:27:13','11:35:03','no'),(170,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 11:35:40 am',4,'2013-12-02','11:35:40','11:39:52','no'),(171,'192.168.43.130','','Existe un error en el Dispositivo: Servidor de prueba de ip: 192.168.43.130 el dia lunes 02 de diciembre del 2013 a las 12:04:52 pm',4,'2013-12-02','12:04:52','00:00:00','si');
...
CREATE TABLE `correo` (
  ...
  CONSTRAINT `correo_ibfk_5` FOREIGN KEY (`correo`) REFERENCES `usuario` (`correo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `correo` VALUES ('192.168.0.13','','joselinber@hotmail.com','si','error'),('192.168.0.13','','manuelenchon@hotmail.com','si','error'),('192.168.0.13','','miguelangel18300@hotmail.com','si','error'),('192.168.43.130','','joselinber@hotmail.com','si','error'),('192.168.43.130','','manuelenchon@hotmail.com','si','error'),('192.168.43.130','','miguelangel18300@hotmail.com','si','error');
...
INSERT INTO `dispositivos` VALUES ('192.168.0.13','Joselin-PC','Joselin Pc','Servidor',' ','Conectado',4,'4'),('192.168.43.130','gustavo-PC','Servidor de prueba','Servidor',' ','Conectado',4,'4');
...
INSERT INTO `pantalla` VALUES ('192.168.0.13','','error','center',10000,'si','falla'),('192.168.43.130','','error','center',10000,'si','falla');
...
INSERT INTO `sonido` VALUES ('192.168.0.13','','Alerta',0,'1',1,'0','falla'),('192.168.43.130','','Alerta',0,'1',0,'0','falla');
...
-- Dump completed on 2013-12-04 22:20:04
