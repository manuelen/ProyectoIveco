...
INSERT INTO `correo` VALUES ('192.168.1.11','','ddd@ws','si','si'),('192.168.1.11','','jjj@jj','si','si'),('192.168.1.11','','joselinber@hotmail.com','si','si'),('192.168.1.11','','manuelenchon@hotmail.com','si','si'),('192.168.1.11','','miguelangel18300@hotmail.com','si','si'),('192.168.1.11','','r@w','si','si'),('192.168.1.11','80','ddd@ws','','si'),('192.168.1.11','80','jjj@jj','','si'),('192.168.1.11','80','joselinber@hotmail.com','','si'),('192.168.1.11','80','manuelenchon@hotmail.com','','si'),('192.168.1.11','80','miguelangel18300@hotmail.com','','si'),('192.168.1.11','80','r@w','','si'),('192.168.1.12','','ddd@ws','si','error'),('192.168.1.12','','jjj@jj','si','error'),('192.168.1.12','','joselinber@hotmail.com','si','error'),('192.168.1.12','','manuelenchon@hotmail.com','si','error'),('192.168.1.12','','miguelangel18300@hotmail.com','si','error'),('192.168.1.12','','r@w','si','error');
...
INSERT INTO `pantalla` VALUES ('192.168.1.11','','error','center',10000,'si','si'),('192.168.1.11','80','error','center',10000,'SI','si'),('192.168.1.12','','error','center',10000,'si','falla');
...
INSERT INTO `sonido` VALUES ('192.168.1.11','','Alerta',0,'1',0,'0','si'),('192.168.1.12','','Alerta',0,'1',1,'0','falla');
...
-- Dump completed on 2013-04-26 10:52:48