...
<form action="javascript:tiempoinactivo();"  action="TiempoInactivo1.php" id="form_puerto" name="traslado1">

<table align="center" cellpadding="7" bgcolor="#C1E0FF" border="1" bordercolor="#FFFFFF" frame="box" style="text-align:left;">  
<tr bgcolor="#000066">
<td colspan="2" align="center"><b><font color="#FFFFFF" size="+1"> Seleccionar fechas de consulta  </font></b></td>
</tr>
...
<tr valign="top">
                    ...
                    <td>
					<input name="fechaini" type="text" id="dateArrival" onClick="popUpCalendar(this, traslado1.dateArrival, 'yyyy-mm-dd');" size="10">
					</td>
                ...
                <tr valign="top">
                    ...
                    <td>
					<input name="fechafin" type="text" id="dateArrival1" onClick="popUpCalendar(this, traslado1.dateArrival1, 'yyyy-mm-dd');" size="10">
					</td>
		 ...
		 function tiempoinactivo(){
			 	if($('#dateArrival').val()>$('#dateArrival1').val()){
					alert("verifique La fecha de Inicio y Fin");
						...
						$(location).attr('href',"TiempoInactivo1.php?fechainicio="+$('#dateArrival').val()+"&fechafin="+$('#dateArrival1').val());
						}
			 }
