...
<td><a href="ModificarUsuario.php?cedula=<?php echo $fila['cedula']; ?>"><label for="accion"><img src="image/iconomodifica.png" style="max-width:40px; max-height:40px; width:100%;height:100%;"</label></td>
