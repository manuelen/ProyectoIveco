...
<html lang="es">
    ...
    <div id="wrap">
	  ...
	  <section id="contenedor">
            ...
            <br /><br /><br />
            <form action="javascript:auditoriapdf();" method="post" id="modi_dispositivo" name="traslado1">

<table align="center" cellpadding="7" bgcolor="#C1E0FF" border="1" bordercolor="#FFFFFF" frame="box">  

                <tr bgcolor="#000066">
                <td colspan="2" align="center"><b><font color="#FFFFFF" size="+1"> Reporte de Auditorias</font></b></td>
                </tr>
  				...
  				<tr valign="top">
                    ...
                    <td>
					<input name="fechainicio" type="text" id="dateArrival" onClick="popUpCalendar(this, traslado1.dateArrival, 'yyyy-mm-dd');" size="10" required><font id="vfecha" style="display:none; font-size:9px" color="red">*Ingrese una fecha mayor a la Fecha de Culminación</font>
					</td>
    	...
    	<script type="text/javascript">    
		 function auditoriapdf(){
			 	if($('#dateArrival').val()>$('#dateArrival1').val()){
					alert("verifique La fecha de Inicio y Fin");
					}else{
						$(location).attr('href',"auditoriapdf1.php?fechainicio="+$('#dateArrival').val()+"&fechafin="+$('#dateArrival1').val());
						}
			 }
